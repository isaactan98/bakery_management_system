	...
	<div class="row content">
		...
		<div class="col-sm-9">
			<div class="container1">
				<body onload="hidefield()"> 	<!--body-->
				<form action="createOrder.php" id="orderForm" method="post"> 		<!--form-->
				<?php
				...
				<div class="row">
					...
					<div class="col-75">
						...
						<select class="time" name="time"><option value="AM">AM</option><option value="PM">PM</option></select>
					</div>
				</div>
				<div class="row">
					<div class="col-25">
