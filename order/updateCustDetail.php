...
echo '<form action="viewOrder.php" enctype="multipart/form-data" method="post">';  // form
...
// cakeFlavour <select>
echo '<br><br>Cake Flavour: '; flavour($cakeFlavour);
...
// cakeFilling <select>
echo '<br><br>Cake Filling : '; filling($cakeFilling); 
...
// cakeShape <select>
echo '<br><br>Cake Shape: '; shape($cakeShape);  
...
// cakeSize <select>
echo '<br><br>Cake Size: '; size($cakeSize); 
...
// cakeBoard <select>
echo '<br><br>Cake Board: '; board($cakeBoard); 
